...
import 'package:abido/app/screens/a_home_screen.dart';
import 'package:abido/app/screens/b_upload_project_screen.dart';
// -----------------------------------------------------------------------------
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: <GoRoute>[
      ...
      GoRoute(
        path: '/$routeVideo',
        name: routeVideo,
        builder: (context, state) => const UploadProjectScreen(),
      ),
